...
- (void)initScrollView
{
    ...
    _herizonScrollView.contentSize = CGSizeMake(loopWith * _countsOfPage, loopHeight);
    ...
    if (_countsOfPage > 0) {
        for (int i = 0 ; i < _countsOfPage; i ++) {
            ...
            if ([object isKindOfClass:[UIImage class]]) {
                ...
                imageView.frame = CGRectMake(loopWith * i, 0, loopWith, loopHeight);
...
- (void)scrollViewWillBeginDragging:(UIScrollView *)scrollView
{
    ...
    if (scrollView.contentOffset.x >= loopWith * (_countsOfPage - 1)) {
